...
<html lang="en">
  ...
  <body>
    ...
    <!-- hero -->
    <section id="hero">
      <div class="text-sm-start bg-warning-subtle">
        <div class="container">
          <div class="d-sm-flex flex-sm-row-reverse align-items-center">
            <img src="p3.jpg" class="img-fluid p-5 m-3" width="510px" />
            <div class="me-auto">
...
<section id="galery" class="bg-warning-subtle pb-5">
    ...
    <!-- footer -->
    <footer>
      <div class="h-2 p-2 pt-4 text-center text-dark">
        <a
          href="instagram.com"
          target="_blank"
          class="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover p-3"
          ><svg
        ...
        <a
          href="twitter.com"
          target="_blank"
          class="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover p-2"
          ><svg
            xmlns="http://www.w3.org/2000/svg"
            width="30px"
            height="30px"
